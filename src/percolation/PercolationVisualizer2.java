package percolation; /******************************************************************************
 * Compilation:  javac PercolationVisualizer2.java
 * Execution:    java PercolationVisualizer2 input.txt
    ...
    public static void draw(Percolation perc, int n) {
        ...
        for (int row = 1; row <= n; row++) {
            for (int col = 1; col <= n; col++) {
                ...
                StdDraw.text(col - 0.5, n - row + 0.5, "" + c++);
            }
        }
...
//    }
    public static void main(String[] args) {
        ...
        int n = 20;         // n-by-n percolation system
